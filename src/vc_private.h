...
/* ---------------- Swapchain ---------------- */
b8                       _vc_priv_create_swapchain(vc_ctx *ctx, vc_swapchain_desc desc, VkExtent2D extent);
b8                       _vc_priv_select_swapchain_configuration(vc_ctx *ctx, vc_swapchain_configuration_query query);
